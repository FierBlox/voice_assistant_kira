#список шуток, взятых из интернета
jokes = [
    ...
    "Программист не стал креативить и назвал детей Новый сын один и Новый сын два.",
    "Задачка, которую хороший программист решит за пару минут, а хороший физик сойдет с ума: — Ася весит 4, 2 метра. За сколько времени она скачается, если ширина канала — 5 кило в секунду?",
    ...
    "Программисты зарабатывают тем, что находят и решают проблемы, а системным администраторам проблемы находят пользователи.",
    "В неделе есть пять плохих дней, когда не работают программы и два хороших, когда не работают программисты.",
]